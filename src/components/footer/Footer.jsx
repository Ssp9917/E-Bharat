...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font bg-gray-300 mt-2" >
                ...
                <div className="flex flex-wrap md:text-left text-center order-first">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <Link className="text-gray-600 hover:text-gray-800">Order</Link>
                            </li>
                            <li>
                                <Link className="text-gray-600 hover:text-gray-800">Local For Vocal</Link>
                            </li>
                            <li>
                                <Link className="text-gray-600 hover:text-gray-800">Cart</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="bg-gray-200" >
                <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 E-bharat —
                        <Link href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">www.ebharat.com</Link>
                    </p>
